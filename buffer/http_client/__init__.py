...
class HttpClient(object):
    ...
    def post(self, path, body=None, options=None):
        if not options:
            options = {}
        if not body:
            body = {}
    ...
    def patch(self, path, body=None, options=None):
        if not options:
            options = {}
        if not body:
            body = {}
    ...
    def delete(self, path, body=None, options=None):
        if not options:
            options = {}
        if not body:
            body = {}
    ...
    def put(self, path, body=None, options=None):
        if not options:
            options = {}
        if not body:
            body = {}
